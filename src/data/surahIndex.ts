// Index statique des 114 sourates du Coran (numéro, nom arabe, nom translittéré, traduction anglaise
// du titre, nombre de versets, lieu de révélation) — utilisé pour la recherche plein texte de la
// palette de commande (voir CommandPalette.tsx) sans dépendre d'un appel réseau à l'ouverture de la
// palette. Les textes et l'audio des versets restent, eux, chargés en direct depuis l'API
// alquran.cloud (voir lib/quranApi.ts) ; les deux fichiers partagent le même identifiant "number".
...
export const surahIndex: SurahMeta[] = [
  ...
  { number: 13, name: 'سُورَةُ الرَّعۡدِ', englishName: "Ar-Ra'd", englishNameTranslation: 'The Thunder', numberOfAyahs: 43, revelationType: 'Medinan' },
  ...
  { number: 16, name: 'سُورَةُ النَّحۡلِ', englishName: 'An-Nahl', englishNameTranslation: 'The Bee', numberOfAyahs: 128, revelationType: 'Meccan' },
  ...
  { number: 27, name: 'سُورَةُ النَّمۡلِ', englishName: 'An-Naml', englishNameTranslation: 'The Ant', numberOfAyahs: 93, revelationType: 'Meccan' },
  ...
  { number: 32, name: 'سُورَةُ السَّجۡدَةِ', englishName: 'As-Sajda', englishNameTranslation: 'The Prostration', numberOfAyahs: 30, revelationType: 'Meccan' },
  ...
  { number: 43, name: 'سُورَةُ الزُّخۡرُفِ', englishName: 'Az-Zukhruf', englishNameTranslation: 'Ornaments of gold', numberOfAyahs: 89, revelationType: 'Meccan' },
  ...
  { number: 53, name: 'سُورَةُ النَّجۡمِ', englishName: 'An-Najm', englishNameTranslation: 'The Star', numberOfAyahs: 62, revelationType: 'Meccan' },
  ...
  { number: 55, name: 'سُورَةُ الرَّحۡمَٰن', englishName: 'Ar-Rahmaan', englishNameTranslation: 'The Beneficent', numberOfAyahs: 78, revelationType: 'Medinan' },
  ...
  { number: 60, name: 'سُورَةُ المُمۡتَحنَةِ', englishName: 'Al-Mumtahana', englishNameTranslation: 'She that is to be examined', numberOfAyahs: 13, revelationType: 'Medinan' },
  ...
  { number: 65, name: 'سُورَةُ الطَّلَاقِ', englishName: 'At-Talaaq', englishNameTranslation: 'Divorce', numberOfAyahs: 12, revelationType: 'Medinan' },
  { number: 66, name: 'سُورَةُ التَّحۡرِيمِ', englishName: 'At-Tahrim', englishNameTranslation: 'The Prohibition', numberOfAyahs: 12, revelationType: 'Medinan' },
  ...
  { number: 69, name: 'سُورَةُ الحَاقَّةِ', englishName: 'Al-Haaqqa', englishNameTranslation: 'The Reality', numberOfAyahs: 52, revelationType: 'Meccan' },
  ...
  { number: 81, name: 'سُورَةُ التَّكۡوِيرِ', englishName: 'At-Takwir', englishNameTranslation: 'The Overthrowing', numberOfAyahs: 29, revelationType: 'Meccan' },
  ...
  { number: 83, name: 'سُورَةُ المُطَفِّفِينَ', englishName: 'Al-Mutaffifin', englishNameTranslation: 'Defrauding', numberOfAyahs: 36, revelationType: 'Meccan' },
  ...
  { number: 91, name: 'سُورَةُ الشَّمۡسِ', englishName: 'Ash-Shams', englishNameTranslation: 'The Sun', numberOfAyahs: 15, revelationType: 'Meccan' },
  { number: 92, name: 'سُورَةُ اللَّيۡلِ', englishName: 'Al-Lail', englishNameTranslation: 'The Night', numberOfAyahs: 21, revelationType: 'Meccan' },
  ...
  { number: 94, name: 'سُورَةُ الشَّرۡحِ', englishName: 'Ash-Sharh', englishNameTranslation: 'The Consolation', numberOfAyahs: 8, revelationType: 'Meccan' },
  ...
  { number: 99, name: 'سُورَةُ الزَّلۡزَلَةِ', englishName: 'Az-Zalzala', englishNameTranslation: 'The Earthquake', numberOfAyahs: 8, revelationType: 'Medinan' },
  ...
  { number: 110, name: 'سُورَةُ النَّصۡرِ', englishName: 'An-Nasr', englishNameTranslation: 'Divine Support', numberOfAyahs: 3, revelationType: 'Medinan' },
